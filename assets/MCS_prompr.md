...
* :core Submodule:
   * :core:common, :core:data, :core:domain, :core:editor, :core:navigation, :core:resourcess, :core:terminal, :core:ui, :core:utils
* :feature Submodule:
...
Aider Prompt:
"Implementiere in den spezifischen :core Submodulen die zentralen Manager als Hilt-Singletons in Kotlin:
...
Aider Prompt:
"Initialisiere die Module :core:ui und :core:resourcess:
...
Aider Prompt:
"Fülle die Module :core:domain und :core:data mit Kotlin-Code:
...
Aider Prompt:
"Implementiere das Modul :core:navigation:
