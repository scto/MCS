...
Erstelle eine vollständige Kotlin-basierte Android-Bibliothek für das Projekt-Template-Management im Namespace com.scto.mcs. Arbeite nach den Prinzipien der Clean Architecture und SOLID. Verwende ausschließlich Kotlin, Coroutines, Flows (StateFlow/SharedFlow) und injiziere Coroutine Dispatchers über den Konstruktor für maximale Testbarkeit.

1. Projekt-Kontext & Struktur (WICHTIG)
Nutze den beiliegenden Projekt-Tree aus der Datei MCS_20260502_125638.md als Referenz für die bestehende Dateistruktur. Lege die neuen Module passend zur bestehenden Architektur im Verzeichnis core/ an. Die Struktur der neuen Module muss exakt so aussehen:
