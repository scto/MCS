...
* :core:domain (UseCases und Geschäftslogik)
3. Aufgabenstellung
Phase 1: Migration & Package Update
1. Verschiebe alle Dateien von assets/src/editor inklusive aller Unterordner in das Ziel-Verzeichnis. Stelle sicher, dass die gesamte Verzeichnisstruktur tiefenanalysiert und migriert wird.
...
2. Architektur-Anpassung:
   * Integriere @Inject (Hilt) für Konstruktoren, wo es sinnvoll ist.
...
Beginne jetzt mit der Analyse des Quellcodes in assets/src/editor (inklusive Unterordner).