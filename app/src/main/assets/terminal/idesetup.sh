#!/data/data/com/scto/mcs/files/usr/bin/bash
...
print_help() {
  echo "MCS build tools installer"
  echo "This script helps you easily install build tools in MCS."
  echo ""
  echo "Usage:"
...
if [ "$jdk_version" == "21" ]; then
  print_warn "OpenJDK 21 support in MCS is experimental. It may or may not work properly."
